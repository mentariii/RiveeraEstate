<footer class="full-row p-0" style="background: #3b5d50">
            <div class="container">
                <div  class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        <div class="footer-logo mb-4"> <a href="#"><img class="logo-bottom" src="images/logo/newputih.png" alt="image"></a> </div>
                                        <p class="pb-20 text-white">Welcome to Riviera Estate, your trusted partner in the world of real estate. Our mission is to provide exceptional real estate services, assisting you in finding the perfect property and making informed decisions.</p>
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    ...
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+62 111-111-1111</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+62 111-111-111</li>
                                                    <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>help.riviera@estate.com</li>
                                                </ul>
                                            </div>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© <?php echo date('Y');?> Riviera Estate Website - Developed By Mentari Dwi Prastiwi</span> </div>
                    <div class="col-sm-6">
