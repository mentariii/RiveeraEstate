...
<link href="images/logo/rlogo.png" rel="shortcut icon">

<!--	Title
	=========================================================-->
<title>Riviera Estate</title>
</head>
<body>
...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/banner/back.jpeg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            <h1 class="mb-4"><span class="text" style="color: #000000;">Let us</span><br>
                            Guide you Home</h1>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                        ...
                        <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Home Sales</a></h5>
                        <p>Explore our professional services for selling your property. We assist you throughout the sales process to maximize your returns.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                        <i class="flaticon-for-rent text-success flat-medium" aria-hidden="true"></i>
                        <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Rental Assistance</a></h5>
                        <p>Find the perfect rental property with our dedicated rental services. We help you locate and secure the ideal home for your needs.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                        ...
                        <p>Explore our extensive property listings. Whether buying or selling, we connect you with the right properties for your preferences.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                        <i class="flaticon-diagram text-success flat-medium" aria-hidden="true"></i>
                        <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Legal Consultation</a></h5>
                        <p>Ensure a secure investment with our legal consultation services. We guide you through the legal aspects of property transactions.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    Mulai
    Deklarasi variabel alas, tinggi, luas (tipe data float)
    
    Tampilkan "Masukkan alas segitiga: "
    Baca input pengguna dan simpan sebagai alas
    
    Tampilkan "Masukkan tinggi segitiga: "
    Baca input pengguna dan simpan sebagai tinggi
    
    Hitung luas = 0.5 * alas * tinggi
    
    Tampilkan "Luas segitiga adalah: " dan luas
...
Selesai
        ...
        <!--	Why Choose Us -->
<div class="full-row living bg-one overlay-secondary-half" style="background-image: url('images/img1.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
    <div class="container">
        <div class="row">
                    ...
                    <ul>
                        <li class="mb-4 text-white d-flex"> 
                            ...
                            <div class="pl-2">
                                ...
                                <p>Choose us for top-rated real estate services. Our commitment to excellence has earned us a reputation as one of the best in the industry.</p>
                            </div>
                        </li>
                        <li class="mb-4 text-white d-flex"> 
                            ...
                            <div class="pl-2">
                                ...
                                <p>Experience the highest quality in real estate services. Our dedicated team ensures that every aspect of your real estate journey is of the utmost quality.</p>
                            </div>
                        </li>
                        <li class="mb-4 text-white d-flex"> 
                            ...
                            <div class="pl-2">
                                ...
                                <p>Trust in our experienced agents to guide you through your real estate transactions. Our team brings years of expertise to every deal.</p>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="icon-thumb-one text-center mb-5">
                    ...
                    <h5 class="text-secondary mt-5 mb-4">Initial Discussion</h5>
                    <p>Start your real estate journey with an initial discussion. Our experts will understand your needs and preferences to tailor our services to you.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="icon-thumb-one text-center mb-5">
                    ...
                    <h5 class="text-secondary mt-5 mb-4">Property Review</h5>
                    <p>We thoroughly review available properties, ensuring that we find options that match your criteria. Our goal is to present you with the best choices.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="icon-thumb-one text-center mb-5">
                    ...
                    <h5 class="text-secondary mt-5 mb-4">Property Acquisition</h5>
                    <p>Once you've found the perfect property, we guide you through the acquisition process. Our team ensures a smooth and successful real estate transaction.</p>
                </div>
            </div>
        </div>
    </div>
